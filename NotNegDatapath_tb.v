...
module NotNegDatapath_tb;
  ...
  // === run NEG first, then NOT once ===
  reg do_not  = 1'b0;
  reg ran_neg = 1'b0;

  always @(posedge clock) begin
    if (Present_state == T4_neg && !ran_neg) begin
      do_not  <= 1'b1;
      ran_neg <= 1'b1;
    end
  end
  ...
  always @(posedge clock) begin
    case (Present_state)
      ...
      T4_neg:     Present_state <= (ran_neg ? T0_not : T0_neg);
  ...
  always @(*) begin
    ...
    case (Present_state)
      ...
      T1_neg: begin
        ...
        // neg is I-format: op=01110, Ra=R4, Rb=R7  -> 32'h72380000
        Mdatain = 32'h8A380000;
      end
      ...
      T3_neg: begin
        ...
        R7out  = 1;
        Zin    = 1;
        opcode = 5'b10001; // NEG op-code from spec
      end
      ...
      T1_not: begin
		  PCout = 0; MARin = 0; IncPC = 0; Zin = 0;
        Zlowout = 1; PCin = 1; Read = 1; MDRin = 1;
        // not is I-format: op=01111, Ra=R4, Rb=R7  -> 32'h7A380000
        Mdatain = 32'h92380000;
      end
      ...
      T3_not: begin
        ...
        R7out  = 1;
        Zin    = 1;
        opcode = 5'b10010; // NOT op-code from cpu spec
      end
