		...
		case(Present_state)
			...
			T1:
				begin
					...
					Read		=1;
					MDRin		=1;
					Mdatain	=32'h81880000; //IR coding for mul r3, r1
				end
				
			T2:
				begin
					
					MDRout	=1;		// Moving instruction from MDR to IR (IR = mul r3,r1)
					IRin		=1;
				end
			...
			T4:
				begin
					...
					opcode	=5'b10000; //opcode for Mult
					Zin		=1;			
				end
